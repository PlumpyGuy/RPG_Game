...
const locations = [
    {
        ...
        text: "You've just left the store and now you are in the town square."
    },
    {
        name: "store",
...
function attack(){
    ...
    health -= getMonsterAttackValue(monsters[fighting].lvl);
    healthText.innerText = health;
    if(health <= 0){
        lose();
...
function restart(){
   ...
   xpText.innerText = xp;
   goTown();
   text.innerText = "Welcome to Dragon Reppler. You must defeat the dragon that is preventing people from leaving the town. You are in the town square. Where do you want to go? Use the buttons above.";
}
